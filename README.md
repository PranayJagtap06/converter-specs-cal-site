# DC-DC Converter Specs Calculator

This a DC-DC converter specification calculator streamlit app which:
 - Calculates key specs like `critical inductance`, `CCM inductance`, & `output capacitance` values. 
 - Along with converter's `Line-to-Output (Gvg)` & `Control-to-Output (Gvd)` transfer function.
