...
$$ {gvd_latex} $$
"""
    return op_string, gvg_latex, gvd_latex, line_to_op_resp, ctrl_to_op_resp, sys_g, sys_d, tg, yg, td, yd
...
def dc_dc_converter(converter_type: str, input_voltage: float, output_voltage: float, output_resistance: float, frequency: float, ripl_current: float, ripl_voltage: float, specs_hist: list) -> Optional[tuple]:
    ...
    try:
        op_string, gvg_latex, gvd_latex, line_to_op_resp, ctrl_to_op_resp, sys_g, sys_d, tg, yg, td, yd = _calculate_core_specs(
...
with gr.Blocks(delete_cache=(86400, 86400)) as demo:        
    ...
    calc_button.click(
        ...
        outputs=[op_label, tf_resp_ttl, ltop_resp_plt, ctop_resp_plt, ltop_resp_ttl, ctop_resp_ttl, history_state]
    ).success(
